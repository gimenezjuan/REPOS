...
<asp:Content ID="Content2" ContentPlaceHolderID="InfoContenido" runat="server">
        <div class="contenidotitulo-pdCliente"><h2>Pedidos realizados por los clientes</h2></div>
        <br />
        <br />
